...
4. **Lire les conventions** : Charger `~/koulia/technos/{stack}/patterns/` pertinents pour le domaine
...
| Patterns | References vers `~/koulia/technos/{stack}/patterns/` |
...
- Les patterns techniques doivent correspondre a ceux documentes dans `~/koulia/technos/{stack}/`
- Les fichiers cibles doivent etre realistes (verifier l'arborescence existante)
- Le plan doit respecter les conventions de `~/koulia/technos/common/`
