...
3. **Adaptive context loading** : Identifier le stack concerne par la story, puis charger UNIQUEMENT les docs koulia pertinentes :
   - `~/koulia/technos/{stack}/patterns/{pattern}.md` references dans la story
   - `~/koulia/technos/common/` pour les conventions transverses
...
3. Suivre les conventions de nommage de `~/koulia/technos/common/naming-conventions.md`
4. Suivre les regles de style de `~/koulia/technos/{stack}/code-style.md`
...
1. Creer un commit atomique avec un message clair :
   ...
   - {changement 2}
   ```
2. Suivre les conventions de `~/koulia/technos/common/git-conventions.md`
...
2. Pour chaque story, creer une instruction worker avec :
   ...
   - Les patterns koulia a respecter
