---
name: code-review
description: Analyser du code modifie et lister les problemes en se basant sur les regles et conventions koulia.
---
...
Analyser du code modifie (commit, branche, fichiers, diff non-committe) et produire un rapport structure des problemes detectes en se basant sur les regles koulia.
...
### Etape 3 — Charger les regles koulia
...
- `~/koulia/technos/{stack}/code-style.md`
- `~/koulia/technos/{stack}/patterns/*.md` (seulement les patterns pertinents)
...
- Respect des patterns koulia (structure, organisation, types)
